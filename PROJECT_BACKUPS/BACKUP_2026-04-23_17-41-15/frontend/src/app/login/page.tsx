          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link href="#" className="text-[10px] text-amber-500 font-black uppercase tracking-widest hover:underline">Forgot?</Link>
              </div>
              <div className="relative group">
            ...
            {message && (
              <div className={`p-4 rounded-xl text-xs font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20`}>
                {message.text}
              </div>
            )}
